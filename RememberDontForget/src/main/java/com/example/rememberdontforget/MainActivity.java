...
public class MainActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks {
    ...
    private static Activity myActContext;
    ...
    public static void addItem(ViewGroup mContainerView) {
        final ViewGroup newView = (ViewGroup) LayoutInflater.from(myActContext).inflate(
                R.layout.list_item_example, mContainerView, false);
        ((TextView) newView.findViewById(android.R.id.text1)).setText(
                PASS[(int) (Math.random() * PASS.length)]);
        newView.setOnTouchListener(new MyListener(mContainerView,myActContext,scroll));
